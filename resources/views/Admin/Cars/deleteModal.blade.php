<div class="modal fade" id="deleteModal{{$Car->id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="/AdminCarDelete/{{$Car->id}}"><img src="/uses/TrashICON.png" alt="Rent A Car" width="25px"
                        height="25px"></a>
